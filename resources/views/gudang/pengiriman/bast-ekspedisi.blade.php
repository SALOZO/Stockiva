                ...
                <form action="{{ route('gudang.pengiriman.cetak-bast-ekspedisi', $pengiriman->id) }}" 
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                                <label for="ekspedisi_id" class="form-label">Nama Ekspedisi <span class="text-danger">*</span></label>
                                <select class="form-select @error('ekspedisi_id') is-invalid @enderror" 
                                    ...
                                    @foreach($ekspedisiList as $ekspedisi)
                                        <option value="{{ $ekspedisi->id }}" 
                                            {{ old('ekspedisi_id', $pengiriman->ekspedisi_id) == $ekspedisi->id ? 'selected' : '' }}>
