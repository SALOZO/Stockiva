        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                    ...
                    <a href="{{ route('gudang.ekspedisi.create') }}" class="btn btn-primary">
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('gudang.ekspedisi.show', $item->id) }}" 
                                           class="btn btn-sm btn-outline-secondary" 
                                           data-bs-toggle="tooltip" 
                                           title="Lihat Detail">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="{{ route('gudang.ekspedisi.edit', $item->id) }}" 
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{ route('gudang.ekspedisi.destroy', $item->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
